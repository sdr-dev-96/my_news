 ...
 */
final class Version20201114215932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, ecrivain_id INT NOT NULL, titre VARCHAR(255) NOT NULL, creation DATETIME NOT NULL, modification DATETIME NOT NULL, contenu LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_23A0E66FBEED4E6 (ecrivain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66FBEED4E6 FOREIGN KEY (ecrivain_id) REFERENCES user (id)');
